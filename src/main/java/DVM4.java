...
public class DVM4 extends Thread implements DVM {
    ...
    public DVM4(ArrayList<Drink> drink_list, int id, int address) {
        this.drink_list = drink_list;
        this.id = id;
        this.address = address;
    }

    public DVM4(ArrayList<Drink> drink_list, int id) {
        this.drink_list = drink_list;
        this.id = id;
    }
    ...
    public static void main(String[] args) {
        ...
        DVM4 dvm4 = new DVM4(drinkArrayList4, 4, 404);
        dvm4.run();
    }
