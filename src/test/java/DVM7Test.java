...
class DVM7Test {
    ...
    void getDrinkListTest(){
        initDrinkList();
        DVM7 dvm = new DVM7(drinkArrayList7, 7, 707);
        ...
        assertEquals(7, drink_list.get(2).getStock());
        assertEquals(5, drink_list.get(3).getStock());
        assertEquals(20, drink_list.get(4).getStock());
        assertEquals(0, drink_list.get(5).getStock());
...
//    }
    ...
    void run_StockResponseTest() throws IOException {
        ...
        Message message = new Message();
        message.createMessage(SOURCE_ID, 7, MsgType.REQUEST_STOCK, "핫식스");
        dummySocket.sendSocket(socket, message);
        Message message2 = new Message();
        message2.createMessage(SOURCE_ID, 7, 999);
    ...
    void  run_ResponseLocationTest() throws IOException {
        ...
        DummySocket dummySocket = new DummySocket();
        Message message = new Message();
        message.createMessage(SOURCE_ID, 7, MsgType.REQUEST_LOCATION);
        dummySocket.sendSocket(socket, message);
        Message message2 = new Message();
        message2.createMessage(SOURCE_ID, 7, 999);
        dummySocket.sendSocket(socket2, message2);
        ...
        assertEquals("707", receivedMessage.getMsg());
    ...
    void run_ResponseSaleCheckTest() throws IOException {
        ...
        DummySocket dummySocket = new DummySocket();
        Message message = new Message();
        message.createMessage(SOURCE_ID, 7, MsgType.DRINK_SALE_CHECK, "핫식스");
        dummySocket.sendSocket(socket, message);
        Message message2 = new Message();
        message2.createMessage(SOURCE_ID, 7, 999);
        dummySocket.sendSocket(socket2, message2);
